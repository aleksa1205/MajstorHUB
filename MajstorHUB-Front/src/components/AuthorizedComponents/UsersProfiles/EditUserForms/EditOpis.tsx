...
function EditOpis({ close, updateUser, userData }: PropsValues) {
  ...
  if (
    ...
    res = (
      <>
        <p>
          Iskoristite ovaj prostor da pokažete klijentima da posedujete veštine
          i iskustvo koje traže.
        </p>
        <ul>
    ...
    res = (
      <>
        <p>
          Iskoristite ovaj prostor da pokažete majstorima i firmama kakve usluge
          i veštine tražite.
        </p>
        <ul>
