            ...
            {transition((style, show) => {
                return show ? (
                    <>
                        ...
                        {type === 'info' && (
                            <InfoBoxAnimated closeMessage={closeMessage} style={style}>
                                <p>{message}</p>
                            </InfoBoxAnimated>
                        )}
                        {type === 'error' && (
                            <ErrorBoxAnimated closeMessage={closeMessage} style={style}>
                                <p>{message}</p>
                            </ErrorBoxAnimated>
                        )}
                        {type === 'warning' && (
                            <WarningBoxAnimated closeMessage={closeMessage} style={style}>
                                <p>{message}</p>
                            </WarningBoxAnimated>
                        )}
                    </>
